...
void setup(void) 
{
  ...
  // draw a single pixel on the top half
  display.drawPixel(10, 10, BLACK);
  display.refreshTop();
  delay(500);
  display.clearDisplay();

  // draw a single pixel on the bottom half
  display.drawPixel(10, 80, BLACK);
  display.refreshBottom();
  delay(500);
  display.clearDisplay();  

  // draw a pixel on the top half and then one on the bottom half
  display.drawPixel(10, 10, BLACK);
  display.refreshTop();
  delay(500);
  display.drawPixel(10, 80, BLACK);
